...
app.post('/signup', (req, res) => {
    ...
    .then(userInfo => {
        if(userInfo){
            console.log("Ya se registro este correo")
        ...
        if (err) {
          ...
          res.cookie('token', token).json({id:userInfo._id,email:userInfo.email, username:userInfo.username});
...
app.listen(4000, function(){
    console.log("Express started in port 4000");
});